...
if(isset($_GET['listVersions'])){
    $array = communicator_client::runfunction('papermc_api_v2::listVersions("' . $_GET['listVersions'] . '");');
...
if(isset($_GET['listBuilds'])){
    $array = communicator_client::runfunction('papermc_api_v2::listBuilds("' . $type . '","' . $_GET['listBuilds'] . '");');
