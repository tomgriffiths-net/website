...
if(isset($_GET['listVersions'])){
    $array = communicator_client::runfunction('forge_installer::listVersions();');
...
if(isset($_GET['listBuilds'])){
    $array = communicator_client::runfunction('forge_installer::listSpecialVersions("' . $_GET['listBuilds'] . '");');
